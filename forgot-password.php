...
$query=mysqli_query($conn,"SELECT * FROM register WHERE email='$email' and mobile='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{

mysqli_query($conn,"update register set password='$password' WHERE email='$email' and mobile='$contact' ");
