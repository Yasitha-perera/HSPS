...
if(isset($_POST['submit'])) 
{
    ...
    $qry=mysqli_query($conn,"SELECT * FROM service WHERE email='$email' AND password='$password'");
    $num=mysqli_fetch_array($qry);
if($num>0)
{
$extra="services_list.php";//
$_SESSION['ser_login']=$_POST['email'];
$_SESSION['id']=$num['id'];
...
?></span>
                            ...
                            <div class="form-check mb-2">
                               ...
                               <p class="text-center pb-4">
                                <a href="provider_forgot-password.php" >Forgot Your Password?</a>
                            </p>
                            </div>

                            <input type="submit" name="submit" class="btn btn-danger submit mb-4"value="Login">
                            <p class="text-center pb-4">
                                <a href="ser_register.php" > Don't have an account?</a>
                            </p>
                        </form>
                    </div>
                    </div>
