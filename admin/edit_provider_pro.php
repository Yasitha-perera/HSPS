...
$sql=mysqli_query($conn,"update service set status='$status' where id='$pid' ");
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post">
                ...
                $query=mysqli_query($conn,"select * from service where id='$pid'");
                  ...
                  <div class="form-group">
                    <label > Service Provider Joining Date</label>
                  ...
                  <div class="form-group">
                    ...
                    <select name="status" class="form-control"   required>
                        <option value="<?php echo ($row['status']);?>" disabled><?php if($row['status'] == 1) { ?>
                                                  <span>Profile is Approved.</span>
                                                <?php } 
                                                 
                                                if($row['status'] == 0) { ?>
                                                  <span>Profile is under Confirmation.</span>
                                                <?php } ?></option> 

                        <option value="0">Profile is under Confirmation.</option>
                        <option value="1">Profile is Approved.</option>
