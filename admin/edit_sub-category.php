...
<?php } }?>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1"> Service Sub-Category Name</label>
                    <input type="text" class="form-control" id="subcategory" name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" placeholder="Enter Sub-Category Name" required="true">
                  </div>
                        <?php } ?>
                </div>
