...
$query=mysqli_query($conn,"INSERT INTO category(categoryName) values ('$cname')");

    if($query)
    {
        echo"Service Category Added succesfull";
              ...
              <form role="form" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="category" name="categoryName" placeholder="Category" required="true">
                  </div>
